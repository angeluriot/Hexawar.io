...
export function hexa_to_rgb(color) {
...
export function rgb_to_hexa(rgb) {
...
export function is_color_dark(color, level) {
    let rgb = hexa_to_rgb(color);
    let brightness = (rgb.r * 299 + rgb.g * 587 + rgb.b * 114) / 1000.;
    return brightness < level;
}
export function change_color(color, dark_level, change_level) {
